...
insert into tb_pessoa (nome_completo, data_nascimento, genero, estrangeiro, cpf, rg, outros_documentos, email, telefone_celular, telefone_fixo, id_endereco_fk, id_escolaridade_fk, id_orgao_instituicao_empresa_fk)
values ('João Silva', '10/01/1980', 'Masculino', 0, '111.222.333-44', '1.222.333', 'CNH: 123456', 'joao@email.com', '67999999999', '6734611111', 1, 1, 1);

insert into tb_pessoa (nome_completo, data_nascimento, genero, estrangeiro, cpf, rg, outros_documentos, email, telefone_celular, telefone_fixo, id_endereco_fk, id_escolaridade_fk, id_orgao_instituicao_empresa_fk)
values ('Maria Silva', '10/01/1980', 'Feminino', 0, '111.222.333-44', '1.222.333', 'CNH: 123456', 'maria@email.com', '67999999999', '6734611111', 2, 2, 2);

insert into tb_pessoa (nome_completo, data_nascimento, genero, estrangeiro, cpf, rg, outros_documentos, email, telefone_celular, telefone_fixo, id_endereco_fk, id_escolaridade_fk, id_orgao_instituicao_empresa_fk)
values ('José Silva', '10/01/1980', 'Masculino', 0, '111.222.333-44', '1.222.333', 'CNH: 123456', 'jose@email.com', '67999999999', '6734611111', 1, 3, 1);